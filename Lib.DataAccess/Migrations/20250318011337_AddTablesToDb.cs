    ...
    public partial class AddTablesToDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CourseCategoryId", "DisplayOrder", "Name" },
                values: new object[,]
                {
                    { 1, 1, "Programming" },
                    { 2, 2, "Business" },
            ...
            migrationBuilder.InsertData(
                table: "Courses",
                columns: new[] { "CourseId", "CategoryId", "CreatedByUserId", "Description", "Title" },
                values: new object[,]
                {
                    { 1, 1, null, "Learn the basics of C# programming with this beginner-friendly course.", "C# for Beginners" },
                    { 2, 2, null, "Explore key strategies for building a successful startup.", "Startup Business Strategies" },
                    { 3, 3, null, "Master the fundamentals of graphic design with this hands-on course.", "Graphic Design Essentials" }
                });
